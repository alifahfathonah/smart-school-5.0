...
app2.controller("subjectController", function ($scope, $http, $sce) {
  ...
  $scope.fetchClasses = function (id) {
    $http
      .post(base_url + "admin/Examination/getSchoolClasses", "", config)
      .then(
        function (success) {
  ...
  $scope.loadClassBatches = function (id) {
    if (id !== "all") {
      ...
      $http
        .post(
          base_url + "admin/Examination/getClassBatches",
          { id: id },
          config
        )
        .then(
  ...
  $scope.loadSubjects = function () {
    $http
      .post(
        base_url + "settings/getSubjects",
        { class_id: $scope.selecedVal, batch_id: $scope.selecedVal2 },
        config
      )
      .then(
        function (success) {
...
app2.controller("templateController", function ($scope, $http, $sce) {
  $scope.getTemplate = function (id) {
    $http
      .post(base_url + "admin/Examination/showResultCard", { id: id }, config)
      .then(
        function (success) {
          //console.log(success);
...
app2.controller("marksheetController", function (
  $scope,
  $http,
  $window,
  $location
  ...
  $scope.initSessions = function (name) {
    Loading("#marksFilterAcademicYears", "Loading...", "", "show");
    $http
      .post(
        base_url + "admin/Examination/getSessions2",
        { role_name: name },
        config
      )
      .then(
  ...
  $scope.initSubjects = function (session_id, class_id, batch_id) {
    ...
    $http
      .post(
        base_url + "admin/Examination/getSubjects4rMarksheet",
        { session_id: session_id, class_id: class_id, batch_id: batch_id },
        config
      )
      .then(
        function (success) {
  ...
  $scope.initExams = function () {
    ...
    $http
      .post(base_url + "admin/Examination/getExams", $scope.filterModel, config)
      .then(
        function (success) {
  ...
  $scope.inProcessMarkSheet = function () {
    ...
    if ($scope.requestText != null) {
      $http
        .post(
          base_url + "examination/inProcessMarkSheet",
          $scope.filterModel,
          config
        )
        .then(
          function (success) {
            ...
            if (success.data.status === "success") {
              ...
              var otherData = {
                class_id: $scope.filterModel.class_id,
                batch_id: $scope.filterModel.batch_id,
  ...
  $scope.getSchoolAdmins = function (otherData) {
    $http.post(base_url + "syllabus/getSchoolAdmins", {}, config).then(
      function (success) {
        publicNotificationViaPusher(
          "lbl_approval_exam_marksheet",
          otherData,
          success.data.new_ids,
          "applications/all",
          { sender: success.data.sender },
          $scope.r_id
        );
      },
      function (error) {
  ...
  $scope.onSubmit = function (valid) {
    if (valid) {
      ...
      $http
        .post(
          base_url + "admin/Examination/fetchStudents",
          $scope.filterModel,
          config
        )
        .then(
  ...
  $scope.saveMarksheet = function () {
    ...
    Loading("#marksStudentsTable", "Loading...", "", "show");
    $http
      .post(base_url + "admin/Examination/saveMarks", $scope.data, config)
      .then(
        function (success) {
          Loading("#marksStudentsTable", "Loading...", "", "hide");
          showNotification(
...
app2.controller("majorSheetController", function (
  $scope,
  $http,
  $window,
  $location,
  ...
  $scope.showAllResultCards = function (ids, obj) {
    ...
    $http
      .post(
        base_url + "admin/Examination/print_all_result_cards",
        { ids: ids, obj: obj },
        config
      )
      .then(
  ...
  $scope.showAllResultCards2 = function (objs) {
    ...
    angular.forEach(objs, function (value) {
      ...
      $http
        .post(
          base_url + "admin/Examination/renderCompletedResultCardSingle",
          value,
          config
        )
        .then(
          function (success) {
            $scope.multi_result_cards.push(
              $sce.trustAsHtml(success.data.template.html)
            );
          },
          function (error) {
            console.log(error.data);
  ...
  $scope.editsaveMarksheet = function (valid) {
    if (valid) {
      ...
      $http
        .post(
          base_url + "admin/Examination/update_marks",
          $scope.editData,
          config
        )
        .then(
  ...
  $scope.deleteMarks = function () {
    ...
    $http
      .post(
        base_url + "admin/Examination/delete_marks",
        $scope.deleteModel,
        config
      )
      .then(
  ...
  $scope.majorsheetPrint = function (id, logo, name, dirr) {
    var d =
      ...
      '<tr><td><strong><?php echo lang("class_name"); ?></strong></td><td><u>' +
      $scope.selectedClassName +
      "</u></td>" +
      '<td><strong><?php echo lang("lbl_batch"); ?></strong></td><td><u>' +
      $scope.selectedBatchName +
      "</u></td>" +
      '</tr><tr><td><strong><?php echo lang("lbl_exam_session"); ?></strong></td><td><u>' +
      $scope.selectedExamName +
      "</u></td></tr>" +
      "</table>" +
      "</div>";
  ...
  $scope.initAcademicYears = function (name) {
  ...
  $scope.initResultCardGroups = function (session_id, class_id, batch_id) {
    ...
    $http
      .post(
        base_url + "admin/Examination/getResultCardGroups",
        { session_id: session_id, class_id: class_id, batch_id: batch_id },
        config
      )
      .then(
        function (success) {
          Loading(
            "#majorSheetFilterResultCardGroups",
            "Loading...",
            "",
            "hide"
          );
  ...
  $scope.onSubmit = function (valid) {
    if (valid) {
      ...
      $http
        .post(
          base_url + "admin/Examination/getStudentsForMajorSheet",
          $scope.filterModel,
          config
        )
        .then(
  ...
  $scope.saveTeacherRemarks = function () {
    $scope.remarksModel.student_id =
      $scope.selected_student_for_teacher_remarks.student_id;
    $scope.remarksModel.exam_id =
      $scope.selected_student_for_teacher_remarks.exam_id;
    Loading("#bs-teacher-remarks-modal-sm", "Loading...", "", "show");
    $http
      .post(
        base_url + "admin/examination/save_teacher_remarks",
        $scope.remarksModel,
        config
      )
      .then(
  ...
  $scope.saveAdministratorRemarks = function () {
    $scope.remarksModel2.student_id =
      $scope.selected_student_for_administrator_remarks.student_id;
    $scope.remarksModel2.result_card_group_id =
      $scope.selected_student_for_administrator_remarks.result_card_group_id;
    Loading("#bs-administrator-remarks-modal-sm", "Loading...", "", "show");
    $http
      .post(
        base_url + "admin/examination/save_administrator_remarks",
        $scope.remarksModel2,
        config
      )
      .then(
        function (success) {
          Loading(
            "#bs-administrator-remarks-modal-sm",
            "Loading...",
            "",
            "hide"
          );
  ...
  $scope.updateTeacherRemarks = function () {
    ...
    $http
      .post(
        base_url + "admin/examination/update_teacher_remarks",
        $scope.showModel,
        config
      )
      .then(
        function (success) {
          Loading(
            "#bs-update-teacher-remarks-modal-sm",
            "Loading...",
            "",
            "hide"
          );
  ...
  $scope.updateAdministratorRemarks = function () {
    Loading(
      "#bs-update-administrator-remarks-modal-sm",
      "Loading...",
      "",
      "show"
    );
    $http
      .post(
        base_url + "admin/examination/update_administrator_remarks",
        $scope.showModel2,
        config
      )
      .then(
...
app2.controller("examSettingsController", function (
  $scope,
  $http,
  $window,
  $location,
  ...
  $scope.initFinalResultCardGroups = function () {
    ...
    $http
      .post(base_url + "admin/Examination/getFinalResultCardGroups", {}, config)
      .then(
        function (success) {
  ...
  $scope.getResultCardGroupExams = function (id) {
    ...
    $http
      .post(
        base_url + "admin/Examination/getExamsByID",
        { exam_ids: exam_ids },
        config
      )
      .then(
  ...
  $scope.saveWeighage = function () {
    ...
    $http
      .post(
        base_url + "admin/Examination/saveFinalWeightage",
        {
          group_id: $scope.filterModel.fwSelectedGroupID,
          exams: $scope.filterModelExams,
        },
        config
      )
      .then(
...
app2.controller("skillAndAssessmentCtrl", function (
  $scope,
  $http,
  $window,
  $location,
  ...
  $scope.fetchStudentsForSkills = function () {
    ...
    $http
      .post(
        base_url + "admin/Examination/get_students_for_skills",
        $scope.filterModel,
        config
      )
      .then(
  ...
  $scope.initSkillAndAssessmentGroups = function (class_id) {
    ...
    $http
      .post(
        base_url +
          "admin/Examination/get_skill_and_assessment_groups_for_class",
        { class_id: class_id },
        config
      )
      .then(
  ...
  $scope.saveSkillAndAssessmentEvaluation = function () {
    ...
    $http
      .post(
        base_url + "admin/Examination/save_students_skills_and_assessments",
        $scope.students,
        config
      )
      .then(
...
app2.controller("onlineAdmissionCtrl", function (
  $scope,
  $http,
  $window,
  $location,
  ...
  $scope.save = function () {
    ...
    var handler = PaystackPop.setup({
      ...
      callback: function (response) {
        ...
        $http
          .post(base_url + "welcome/save_admission", $scope.formModel, config)
          .then(
            function (success) {
...
app2.controller("accountController", function ($scope, $http, $sce) {
  ...
  $scope.saveRequisition = function () {
    ...
    $http
      .post(
        base_url + "admin/requisition/saveRequisition",
        $scope.formModel,
        config
      )
      .then(
...
app2.controller("ledgerController", function ($scope, $http) {
  ...
  $scope.getLedgerData = function () {
    ...
    $http
      .post(base_url + "admin/accounts/get_ledger", $scope.formModel, config)
      .then(
        function (success) {
  ...
  $scope.getTrialBalanceData = function () {
    ...
    $http
      .post(
        base_url + "admin/accounts/get_trial_balace_report",
        $scope.formModel3,
        config
      )
      .then(
  ...
  $scope.getLedgerSummaryData = function () {
    ...
    $http
      .post(
        base_url + "admin/accounts/get_ledger_summary",
        $scope.formModel2,
        config
      )
      .then(
...
app2.controller("jvController", function ($scope, $http, $sce) {
  ...
  $scope.savejv = function () {
    $scope.alert = {};
    if (
      $scope.formModel.transcations.length > 1 &&
      $scope.debit - $scope.credit == 0
    ) {
      Loading("#jv-add-form-content", "Loading...", "", "show");
      $http
        .post(base_url + "admin/accounts/save_jv", $scope.formModel, config)
        .then(
          function (success) {
