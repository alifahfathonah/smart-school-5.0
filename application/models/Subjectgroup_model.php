...
class Subjectgroup_model extends MY_Model {
    ...
    public function class_exists($str) {
        ...
        if ($res) {
            ...
            $this->form_validation->set_message('class_exists', $this->lang->line('Record already exists'));
            return false;
        } else {
            return true;
        }
    ...
    function check_section_data_exists($sections, $id) {
        // $this->db->select('*')->from('subject_group_class_sections');
