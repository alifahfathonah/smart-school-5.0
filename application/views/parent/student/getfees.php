                                                    ...
                                                    <td>
                                                        <div class="btn-group pull-right"> 
                                                            ...
                                                            if ($feetype_balance > 0) {
                                                                ...
                                                                <!--<a href="javascript:payfee(<?php echo $fee->id; ?>, <?php echo $fee_value->fee_groups_feetype_id; ?>, <?php echo $student['id']; ?>);" class="btn btn-xs btn-primary pull-right myCollectFeeBtn"><i class="fa fa-money"></i> Pay2</a>-->
