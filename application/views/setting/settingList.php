            ...
            <div class="col-md-2">
                <div class="box box-primary">
                    <div class="box-body text-center">
                        ...
                        <br/>
                        <br/>
                        <a href="#schsetting" role="button" class="btn btn-primary btn-sm upload_logo" data-toggle="tooltip" title="<?php echo $this->lang->line('edit_logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit')." ".$this->lang->line('print')." ".$this->lang->line('logo'); ?></a>
                    </div>
                </div>
                <div class="box box-primary">
                    <div class="box-body text-center">
                        ...
                        if ($settinglist[0]['admin_logo'] == "") {
                            ...
                            ?>
                            <img src="<?php echo base_url() ?>uploads/school_content/admin_logo/<?php echo $settinglist[0]['admin_logo']; ?>" class="img-thumbnail" alt="Cinque Terre" width="204" height="60">
                            <?php
                        }
                        ?>
                        <br/>
                        <br/>
                        <a href="#admin_logo" role="button" class="btn btn-primary btn-sm upload_admin_logo" data-toggle="tooltip" title="<?php echo $this->lang->line('edit_logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit')." ".$this->lang->line('admin')." ".$this->lang->line('logo'); ?></a>
                    </div>
                </div>
                <div class="box box-primary">
                    <div class="box-body text-center">
                        ...
                        <br/>
                        <br/>
                        <a href="#admin_small_logo" role="button" class="btn btn-primary btn-sm upload_admin_small_logo" data-toggle="tooltip" title="<?php echo $this->lang->line('edit_logo'); ?>" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('edit')." ".$this->lang->line('admin')." ".$this->lang->line('small')." ".$this->lang->line('logo'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-10">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <?php foreach ($currencyPlace as $currency_place_k => $currency_place_v) {
                                                    ?>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="currency_place" value="<?php echo $currency_place_k; ?>" <?php
