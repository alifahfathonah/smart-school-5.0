...
<html <?php echo $this->customlib->getRTL(); ?>>
    <head>
       ...
       <link href="<?php echo base_url(); ?>uploads/school_content/admin_small_logo/<?php $this->setting_model->getAdminsmalllogo();?>" rel="shortcut icon" type="image/x-icon">
        ...
        <script src="<?php echo base_url(); ?>assets/jquery-ui-timepicker-addon.js"></script>
        <link href="<?php echo base_url(); ?>assets/jquery-ui-timepicker-addon.css"/>
        ...
        <!-- Loading overlay -->
        <script src="<?php echo base_url() ?>assets/loading/loadingoverlay.min.js"></script>
        <script src="<?php echo base_url() ?>assets/loading/loadingoverlay_progress.min.js"></script> 
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>backend/dist/datatables/css/jquery.dataTables.min.css" />
        <!-- jQuery UI CSS -->
        <link href="<?php echo base_url(); ?>assets/xcrud/plugins/jquery-ui/jquery-ui.min.css" rel="stylesheet" />
        <!-- jQuery UI Timepicker CSS -->
        <link href="<?php echo base_url(); ?>assets/xcrud/plugins/timepicker/jquery-ui-timepicker-addon.css" rel="stylesheet"/>
    </head>
    <body class="hold-transition skin-red fixed sidebar-mini"  ng-cloak ng-app="myApp">

        <div id="toast-container" class="toast-top-right" style="display:none">
            <div class="toast" id="toast-type" style="">
                <button class="toast-close-button">×</button>
                <div class="toast-message" id="toast-body"></div>
            </div>
        </div>
 <?php
                        ...
                        <div class="pull-right">
                            ...
                            <div class="navbar-custom-menu">
                                ...
                                <ul class="nav navbar-nav headertopmenu">
                                    ...
                                    <li class="cal15">
                                        <a href="<?php echo base_url() ?>admin/schoolstore/checkout/">
                                            <i class="fa fa fa-shopping-cart"></i>
                                            <?php if($this->session->userdata("admin_cart_count") > 0) { ?>
                                            <span class="badge badge-warning" style="vertical-align: top; margin-top: -10px; margin-left:-10px; padding: 4px 7px; color: blue; background-color: white;"><?php echo $this->session->userdata("admin_cart_count"); ?></span>
                                            <?php } ?>
                                        </a>
                                    </li>
 <?php
...
<script>
    function customPrint2(id,title) {
        $("#" + id).print({
            globalStyles: true,
            mediaPrint: false,
            stylesheet: "",
            ...
            iframe: true,
            append: null,
            prepend: "<h4 class='text-center'>"+title+"</h4>",
...
<script>
    function customPrint22(id,title) {
        $("#" + id).print({
            globalStyles: false,
            mediaPrint: false,
            stylesheet: "<?php echo base_url(); ?>assets/css/pos_receipt.css",
            noPrintSelector: ".no-print",
            iframe: true,
            append: null,
            prepend: "",
    ...
    function requisition_report(id){
        $.ajax({
            type: "POST",
            url: base_url + "admin/requisition/get_report",
            data: {'id': id},
            dataType: "html",
            success: function (data) { 
                $("#responsive-modal3").modal("show");
                $("#responsive-modal-body3").html(data);
                //console.log(data);
                //successMsg("Status Change Successfully");
                //window.location.reload('true');
            }
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-title"><strong style="font-size: 18px;">Order Details</strong>
                </div>
            </div>
            <div class="modal-body" id="responsive-modal-body">
                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                <a href="javascript:customPrint2('responsive-modal-body','Order Detail Report')" class="btn btn-danger waves-effect waves-light"><i class="fa fa-print"></i> Print</a>
            </div>
        </div>
    </div>
</div>
...
<div id="responsive-modal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="responsive-modal-body2">
                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                <a href="javascript:customPrint22('responsive-modal-body2','Order Detail Report')" class="btn btn-danger waves-effect waves-light"><i class="fa fa-print"></i> Print</a>
            </div>
        </div>
    </div>
</div>
...
<div id="responsive-modal3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <div class="modal-title"><strong style="font-size: 18px;">Requisitions</strong>
                </div>
            </div>
            <div class="modal-body" id="responsive-modal-body3">
                
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                <a href="javascript:customPrint2('responsive-modal-body3','Requisition Report')" class="btn btn-danger waves-effect waves-light"><i class="fa fa-print"></i> Print</a>
            </div>
        </div>
    </div>
</div>
