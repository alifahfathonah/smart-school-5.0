        ...
        <ul class="sidebar-menu verttop">
                ...
                if (($this->rbac->hasPrivilege('student', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php } ?><?php if ($this->rbac->hasPrivilege('online_admission', 'can_view')) { ?>
            ...
            <li class="treeview <?php echo set_Topmenu('Procurement'); ?>">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->rbac->hasPrivilege('requisition', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('Procurement/index'); ?>"><a href="<?php echo site_url('admin/requisition/index'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line("requisition"); ?></a></li>
                        <?php
                    }

                    if ($this->rbac->hasPrivilege('pending_requests', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('Procurement/listing'); ?>"><a href="<?php echo site_url('admin/requisition/listing'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line("pending_requests"); ?> 
                            <?php if($this->session->userdata("admin")["requisition_count"] != 0) { ?>
                                <span class="badge pull-right"><?php echo $this->session->userdata("admin")["requisition_count"]; ?></span>
                            <?php } ?>
                        </a></li>
                        <?php
                    } ?>

                    <?php if ($this->rbac->hasPrivilege('history', 'can_view')) { ?>
                        <li class="<?php echo set_Submenu('Procurement/history'); ?>"><a href="<?php echo site_url('admin/requisition/history'); ?>"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line("history"); ?></a></li>
                        <?php
                    } ?>
