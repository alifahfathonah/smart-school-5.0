                        ...
                        <div class="pull-right">
                            ...
                            <div class="navbar-custom-menu">
                                ...
                                <ul class="nav navbar-nav headertopmenu"> 
                                    <li class="cal15">
                                        <a href="<?php echo base_url() ?>parent/parents/checkout/">
                                            <i class="fa fa fa-shopping-cart"></i>
                                            <?php if($this->session->userdata("cart_count") > 0) { ?>
                                            <span class="badge badge-warning" style="vertical-align: top; margin-top: -10px; margin-left:-10px; padding: 4px 7px; color: blue; background-color: white;"><?php echo $this->session->userdata("cart_count"); ?></span>
                                            <?php } ?>
                                        </a>
                                    </li>
...
<?php } if ($this->parentmodule_lib->hasActive('hostel_rooms')) {
?>
