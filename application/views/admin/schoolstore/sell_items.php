...
<script>
    $(document).ready(function(){
        $("#searchForm").on("submit", function(e){
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url('admin/schoolstore/searchItems'); ?>",
                method: "POST",
                        ...
                        <div class="col-md-12">
                            <ul class="list-group">
                                <?php foreach($itemcategories as $c) { ?>
                                    <li class="list-group-item"><a href="<?php echo base_url(); ?>admin/schoolstore/sell_items/<?php echo $c->id; ?>"><?php echo $c->item_category; ?></a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
                                ...
                                <?php foreach($items as $item) { ?>
                                    <div class="col-md-3 text-center" style="margin-bottom: 15px;">
                                        <div class="col-md-12" style="border: 1px solid orange; border-radius: 10px;">
                                            <img src="<?php echo base_url(); ?>uploads/schoolstore/<?php echo $item->picture; ?>" style="height: 180px; width: 100%; margin-top: 5px;"/>
                                            ...
                                            <form action="<?php echo site_url('admin/schoolstore/savetocart'); ?>" method="post">
