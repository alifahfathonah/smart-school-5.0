...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content">
       <div class="col-md-12">
        ...
        <div class="row">
          <?php if($this->rbac->hasPrivilege('fees_awaiting_payment_widegts','can_view')){
            ?>
      ...
      <?php if($this->rbac->hasPrivilege('conveted_leads_widegts','can_view')){
            ?>
            <div class="col-md-3 col-sm-6">
              <div class="topprograssstart">
                <p class="text-uppercase mt5 clearfix"><i class="fa fa-ioxhost ftlayer"></i> <?php echo $this->lang->line('converted')." ".$this->lang->line('leads')?><span class="pull-right"><?php  echo $total_complete; ?>/<?php echo $total_enquiry; ?></span>
               </p>
              <div class="progress-group">
                 <div class="progress progress-minibar">
          ...
          if($this->rbac->hasPrivilege('staff_present_today_widegts','can_view')){
            ?>
             <div class="col-md-3 col-sm-6">
              <div class="topprograssstart">
                <p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('staff').' '.$this->lang->line('present').' '.$this->lang->line('today'); ?><span class="pull-right"><?php echo $Staffattendence_data; ?> /<?php echo $getTotalStaff_data; ?></span>
               </p>
              <div class="progress-group">
                 <div class="progress progress-minibar">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="topprograssstart">
                <p class="text-uppercase mt5 clearfix"><i class="fa fa-calendar-check-o ftlayer"></i><?php echo $this->lang->line('student').' '.$this->lang->line('present').' '.$this->lang->line('today'); ?><span class="pull-right"> <?php echo $attendence_data['total_half_day']+$attendence_data['total_late']+$attendence_data['total_present'];?> / <?php echo $total_students ; ?></span>
               </p>
              <div class="progress-group">
                 <div class="progress progress-minibar">
          ...
          <div class="row">
                            ...
                            if ($this->rbac->hasPrivilege('fees_collection_and_expense_monthly_chart', 'can_view')) {
                                ...
                                <div class="box box-primary borderwhite">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><?php echo $this->lang->line('_expenses_for')?> <?php echo date('F') . " " . date('Y'); ?></h3>
                                    ...
                                    <div class="box-body">
                                        <div class="chart">
                                            <canvas id="barChart" style="height:222px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            <?php }  }?>
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col40">
              <?php if($this->rbac->hasPrivilege('income_donut_graph','can_view')){
                ?>
              <div class="">
                <div class="info-box"><canvas id="doughnut-chart" width="800" height="450"></canvas> </div>
              </div><!--./col-md-6-->
              ...
              <?php
                            if (($this->module_lib->hasActive('fees_collection')) && ($this->module_lib->hasActive('expense'))) { if ($this->rbac->hasPrivilege('fees_collection_and_expense_yearly_chart', 'can_view')) {
                                ...
                                <div class="box box-info borderwhite">
                                    ...
                                    <div class="box-body">
                                        <div class="chart">
                                            <canvas id="lineChart" style="height:222px"></canvas>
                                        </div>
                                    </div>
                                </div>
                            <?php 
...
new Chart(document.getElementById("doughnut-chart"), {
    ...
    data: {
     ...
     options: {
                ...
                title: {
                    display: true,
                    text: '<?php echo $this->lang->line('income')?>'
                },
                animation: {
                    animateScale: true,
                    animateRotate: true
...
new Chart(document.getElementById("doughnut-chart1"), {
      ...
      datasets: [
        {
          ...
          backgroundColor: [<?php $ss=1;foreach($expensegraph as $value){ ?>"<?php echo expensegraphColors($ss++); ?>", <?php } ?>],
   ...
   options: {
                ...
                title: {
                    display: true,
                    text: '<?php echo $this->lang->line('expense')?>'
                },
                animation: {
                    animateScale: true,
                    animateRotate: true
