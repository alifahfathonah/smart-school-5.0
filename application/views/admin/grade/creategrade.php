            ...
            if ($this->rbac->hasPrivilege('marks_grade', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- form start -->
                        <form id="form1" action="<?php echo site_url('admin/grade') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <th width="40%">Percent From / Upto</th>
                                        ...
                                        foreach ($grade['exam_grade_values'] as $grade_key => $grade_value) {
                                                   ...
                                                   <tr>                
                                                    ...
                                                    <!-- <td>
                                                        ...
                                                        <?php //echo $grade_value->mark_upto . " " . $this->lang->line('to') . " " . $grade_value->mark_from; ?>

                                                        <?php
                                                    }
                                                    ?>
                                                </td> -->
                                               <!--  <td><i class="fa fa-angle-double-right"></i><strong></strong> <?php //echo $this->lang->line('point') ?></strong> <?php echo $grade_value->point ?></td> -->
