...
if(!$staffid_auto_insert){
    ...
    <?php
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('proc_roles'); ?></label>
                                                <select id="proc_roles" name="proc_roles[]" class="form-control select2" multiple="multiple" style="width: 100%;">
                                                    <?php foreach ($proc_roles as $key => $value) {
                                                        ?>
                                                        <option value="<?php echo $value->id; ?>" <?php echo set_select('proc_roles', $value->id, set_value('proc_roles')); ?>><?php echo $value->name; ?></option>
                                                    <?php }
                                                    ?>
                                                </select> 
                                                <span class="text-danger"><?php echo form_error('proc_roles'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
