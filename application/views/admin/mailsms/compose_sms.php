            ...
            <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                  ...
                  <li><a href="#tab_birthday" data-toggle="tab"><?php echo $this->lang->line('todays_birtday'); ?></a></li>
                        ...
                        <li class="pull-left header"><i class="fa fa-mobile-phone"></i> <?php echo $this->lang->line('send')." ".$this->lang->line('sms')?></li>
                    </ul>
                            ...
                            <form action="<?php echo site_url('admin/mailsms/send_group') ?>" method="post" id="group_form">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="group_send_by" value="sms">
                                        </div>
                                        <div class="col-md-4">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <input type="hidden" name="individual_send_by" value="sms">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('message'); ?></label><small class="req"> *</small>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                             ...
                                             <input type="hidden" name="class_send_by" value="sms">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <input type="hidden" name="birthday_send_by" value="sms">
...
<hr>
        ...
        foreach ($birthDaysList['students'] as $student_key => $student_value) {
          ...
          ?>
            <div class="checkbox">
            <label><input type="checkbox" name="user[]" value="<?php echo $student_value['contact_no']?>" checked> <b><?php echo $student_value['name']; ?></b></label>
            </div>
          <?php
        }
        ?>
...
<hr>
 <div class="wellscroll">
        ...
        foreach ($birthDaysList['staff'] as $staff_key => $staff_value) {
          ...
          ?>
            <div class="checkbox">
            <label><input type="checkbox" name="user[]" value="<?php echo $staff_value['contact_no']?>" checked> <b><?php echo $staff_value['name']; ?></b></label>
            </div>
          <?php
        }
           ?>
