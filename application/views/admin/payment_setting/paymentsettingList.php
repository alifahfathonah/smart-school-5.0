            ...
            <div class="col-md-9">
                <div class="nav-tabs-custom box box-primary">
                    <ul class="nav nav-tabs pull-right">
                        <li><a href="#tab_5" data-toggle="tab">Pay Stack</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-7">
                                                ...
                                                ?>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('admission_fee'); ?>
                                                    </label>
                                                    <div class="col-sm-7">
                                                        <input type="number" class="form-control" name="admission_fee" value="<?php echo isset($paystack_result->admission_fee) ? $paystack_result->admission_fee : ""; ?>">
                                                        <span class="text text-danger admission_fee_error"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><?php echo $this->lang->line('paystack_secret_key'); ?>
                                                    </label>
                                                    <div class="col-sm-7">
                                                        <input type="text" class="form-control" name="paystack_secret_key" value="<?php echo isset($paystack_result->api_secret_key) ? $paystack_result->api_secret_key : ""; ?>">
                                            ...
                                            <div class="col-md-5 text text-center disblock">
                                                <a href="https://www.paystack.com" target="_blank"><img src="<?php echo base_url() ?>backend/images/paystack_new.png" width="200"><p>https://www.paystack.com</p></a>
                                            </div>
                                        </div>
                                    </div>
