        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
                    <div class="box-body" id="trialBalanceFormBody">
                        <form name="trialBalanceForm" ng-submit="getTrialBalanceData(trialBalanceForm.$valid)" novalidate="">
                            <div class="form-group">
                                <label>From:</label>
                                <input type="text" name="from_date" class="form-control mydatepicker-autoclose" ng-model="formModel3.from_date" ng-init="formModel3.from_date='<?php echo $from_date; ?>'"/>
                            </div>
                            <div class="form-group">
                                <label>To:</label>
                                <input type="text" name="to_date" class="form-control mydatepicker-autoclose" ng-model="formModel3.to_date" ng-init="formModel3.to_date='<?php echo $to_date; ?>'"/>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table table-default">
                                    ...
                                    <tr ng-repeat="s in trialBalance" ng-if="trialBalance.length>0">
                                        <td>{{s.id}}</td>
                                        <td>{{s.account_no}}</td>
                                    ...
                                    <tr ng-if="trialBalance.length==0">
                                        <td colspan="8"><span class="text-danger">No record found!</span></td>
                                    </tr>
                                    <tr>
                                        <th style="border-top: 2px solid; border-bottom: 2px solid; text-align: right;" colspan="5">Total</th>
                                        <th style="border-top: 2px solid; border-bottom: 2px solid;">{{total_trial_debit_balance}}</th>
                                        <th style="border-top: 2px solid; border-bottom: 2px solid;">{{total_trial_credit_balance}}</th>
                                    </tr>
                                    <tr>
