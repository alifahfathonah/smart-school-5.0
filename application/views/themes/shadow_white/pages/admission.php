...
<!-- start of paystack script -->
<script>
    function payWithPaystack(){
      var handler = PaystackPop.setup({
      //key: 'sk_live_7fd30c7e26bdf694f0f71e3e0bd2ca469f255723',
      //key: 'sk_test_c2623a1e2ef39e9a161783d413a4e9ddf7f6d1c1',
      //key: 'pk_live_e144320254293cd153a4fd7e3d2b30a76bdc00b3',
      key: 'pk_test_9e64ab4e6451e95b223dea17d4d44188083b1cb5',
      ...
      callback: function(response){
            ...
            formData += "&transaction_ref_no=" + response.reference;
            formData += "&paid_amount=10000";
            $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>welcome/save_admission",
               data: formData,
...
<!-- end of paystack script -->
<form id="form1" class="spaceb60 spacet60 onlineform" action="javascript:payWithPaystack();"  name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
  <?php
 ...
 <div class="row">                               
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input id="passport" name="passport" placeholder="" type="text" class="form-control" required="" value="<?php echo set_value('passport'); ?>" />
  ...
  <div class="row"> 
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input  type="text" class="form-control date2"  value="<?php echo set_value('dob'); ?>" id="dob" name="dob" readonly="readonly" required=""/>
                ...
                <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input id="guardian_phone" name="guardian_phone" placeholder="" type="text" class="form-control"  value="<?php echo set_value('guardian_phone'); ?>" required="" />
