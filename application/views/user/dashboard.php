                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        if (!empty($student['image'])) {
                            echo base_url() . "uploads/student_images/".$student['image'];
                        } else {
                                        ...
                                        if (!empty($exam_value->exam_result)) {
                                            if ($exam_value->exam_result['exam_connection'] == 0) {
                                                if (!empty($exam_value->exam_result['result'])) {
                                                    ...
                                                    <table class="table table-striped table-hover example ptt10">
                                                        <thead>
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        ?>
                                                                                        <div class="col-sm-2 pull no-print">   
                                                                                            <div class="description-block">  
                                                                                        ...
                                                                                        <div class="col-sm-3 pull no-print"><div class="description-block"><h5 class="description-header"><?php echo $this->lang->line('quality') . " " . $this->lang->line('points') ?> :  <span class="description-text"><?php echo $exam_quality_points . "/" . $exam_credit_hour . '=' . number_format($exam_quality_points / $exam_credit_hour, 2, '.', ''); ?>  
                                                                                                    </span></h5></div>
                                                                                        </div> 
                                                                                                            ...
                                                                                                            <td>
                                                                                                                ...
                                                                                                                if ($exam_result_value->get_marks < $exam_result_value->min_marks) {
                                                                                                                    ...
                                                                                                                    if ($exam_value->exam_type != "gpa") {
                                                                                                                        ...
                                                                                                                        <?php echo $this->lang->line('percentage') ?> : <?php
                                                                                                                        $exam_percentage = ($exam_get_total * 100) / $exam_grand_total;
                                                                                                                        echo number_format($exam_percentage, 2, '.', '');
                                                                                                                        ?>
                                                                                                                        <?php echo $this->lang->line('result'); ?> :
                                                                                                                        ...
                                                                                                                        <?php echo $this->lang->line('grand') . " " . $this->lang->line('total'); ?> : <?php echo $exam_grand_total; ?>
                                                                                                                        <?php echo $this->lang->line('total') . " " . $this->lang->line('obtain') . " " . $this->lang->line('marks'); ?> : <?php echo $exam_get_total; ?>
                                                                                                                        <?php
                                                                                                                    } elseif ($exam_value->exam_type == "gpa") {
                                                                                                                        ?>
                                                                                                                        <?php echo $this->lang->line('credit') . " " . $this->lang->line('hours'); ?> : <?php echo $exam_credit_hour; ?>
                                                                                                                        <?php echo $this->lang->line('quality') . " " . $this->lang->line('points'); ?> : <?php echo $exam_quality_points . "/" . $exam_credit_hour . '=' . number_format($exam_quality_points / $exam_credit_hour, 2, '.', ''); ?>
                                                                                                                        <?php
                                                                                                                    }
                                                                                                                }
                                                                                                                ?>
...
//                                                                                                    print_r($each_exam_value->id);
                                                                                                                ...
                                                                                                                if ($consolidate_exam_result) {
                                                                                                                    ...
                                                                                                                    echo $this->lang->line('result') . " :" . $consolidate_exam_result;
