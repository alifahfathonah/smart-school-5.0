...
class Xcrud_config
{
    ...
    public static $dbname = 'smart-school-5.0'; // Your database name
    ...
    /*public static $dbname = 'uvs_sandbox'; // Your database name
    public static $dbuser = 'uvs_sandbox'; // Your database username
    public static $dbpass = 'uvs_sandbox'; // // Your database password
    public static $dbhost = 'localhost'; // Your database host, 'localhost' is default.*/
