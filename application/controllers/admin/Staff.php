...
class Staff extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        $data["proc_roles"]     = $this->common_model->dbSelect("*","proc_roles"," 1 ");
        ...
        if ($this->form_validation->run() == true) {
            ...
            $proc_roles        = $this->input->post("proc_roles");
            ...
            if (isset($proc_roles)) {
                  $data_insert['proc_roles']         = implode(",", $proc_roles);
            }
...
$this->load->view('layout/footer', $data);
    ...
    public function edit($id)
    {
        ...
        $staff["proc_roles"]         = explode(",", $staff["proc_roles"]);
        $data['staff']               = $staff;
        $data["contract_type"]       = $this->contract_type;
        $data['sch_setting']         = $this->sch_setting_detail;
        $data['staffid_auto_insert'] = $this->sch_setting_detail->staffid_auto_insert;
